...
const AddressItem = ({ content }) => {
    return (
        <article className={styles['address-content']} >
            ...
            <div className={styles['address-info']}>
                <h4 className={styles['address-info-content']}>{content.address}</h4>
                <div>
                    <h5 className={styles['address-info-title']}>Координати: </h5>
                    <h6 className={styles['address-info-location']}>x: {content.location.x}</h6>
                    <h6 className={styles['address-info-location']}>y: {content.location.y}</h6>
                </div>
            </div>
        </article>
    );
